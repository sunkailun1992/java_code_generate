 ...
 * @author 孙凯伦
 */
public class EntityBOAction extends BaseAnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        ProgressManager.getInstance().run(
                new Task.Backgroundable(project, "Generating Entity BO Code...", false) {
