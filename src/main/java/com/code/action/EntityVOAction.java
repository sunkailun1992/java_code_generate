 ...
 * @author 孙凯伦
 */
public class EntityVOAction extends BaseAnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        ProgressManager.getInstance().run(
                new Task.Backgroundable(project, "Generating Entity VO Code...", false) {
